---
title: Resolución 890 de 2023 — Etiquetado y composición de productos textiles
...
1. **Composición**: Porcentaje de cada fibra presente en el producto, en orden descendente por peso.
2. **País de origen**: País donde se realizó la última transformación sustancial del producto.
3. **Instrucciones de cuidado**: Símbolos internacionales de lavado, secado, planchado y limpieza según la norma ISO 3758.
4. **Identificación del fabricante o importador**: Razón social, NIT y datos de contacto.
5. **Talla**: Según el sistema de tallaje vigente.
